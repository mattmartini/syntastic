...
if exists('g:loaded_syntastic_bash_checkbashisms_checker')
    finish
endif
let g:loaded_syntastic_bash_checkbashisms_checker = 1

let s:save_cpo = &cpo
set cpo&vim

function! SyntaxCheckers_bash_checkbashisms_GetLocList() dict
