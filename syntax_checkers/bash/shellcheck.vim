...
if exists('g:loaded_syntastic_bash_shellcheck_checker')
    finish
endif
let g:loaded_syntastic_bash_shellcheck_checker = 1

let s:save_cpo = &cpo
set cpo&vim

function! SyntaxCheckers_bash_shellcheck_GetLocList() dict " {{{1
    let buf = bufnr('')
